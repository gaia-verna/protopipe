...
class TrainModel(object):
    ...
    def split_data(self, data_sig, train_fraction, data_bkg=None, force_same_nsig_nbkg=False):
        ...
        if self.case in 'regressor':
            X_train, X_test, y_train, y_test, self.data_train, self.data_test = \
                split_train_test(
                    ds=data_sig,
            ...
            X_train_sig, X_test_sig, y_train_sig, y_test_sig, data_train_sig, data_test_sig = \
                split_train_test(
                    ds=data_sig,
                    train_fraction=train_fraction,
                    feature_name_list=self.feature_name_list,
            ...
            X_train_bkg, X_test_bkg, y_train_bkg, y_test_bkg, data_train_bkg, data_test_bkg = \
                split_train_test(
                    ds=data_bkg,
                    train_fraction=train_fraction,
                    feature_name_list=self.feature_name_list,
